                        ...
                        <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                          ...
                          <li>
                            <NavLink
                              to="/"
                              className={
                                'group relative flex items-center justify-between gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out '
                              }
                            >
                              Analytics
                      ...
                      >
                        <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                          ...
                          <li>
                            <NavLink
                              to=""
                              className="group relative flex items-center justify-between gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 "
                            >
                              Pro Form Elements
                              <span className="absolute right-4 block rounded bg-primary px-2 py-1 text-xs font-medium text-white">
                                Pro
                          ...
                          <li>
                            <NavLink
                              ...
                              className={({ isActive }) =>
                                'group relative flex items-center justify-between gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ' +
                                (isActive && '!text-white')
                              }
                            >
                              Pro Form Layout
                      ...
                      >
                        <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                          ...
                          <li>
                            ...
                            >
                              Cannot See
                              <div className="text-sm  text-white bg-primary dark:fill-white  rounded-sm	pr-1 pl-1 ">
                                Pro
                              </div>
                            </NavLink>
                          </li>
